...
import { fetchProduct } from '../../store/public/product-slice';
import Breadcrumbs from '../../components/public/breadcrumbs';
import MarketplaceList from '../../components/public/marketplace-list';
import Reviews from '../../components/public/reviews';
import { AppDispatch, RootState } from '../../store/store';
import ReturnBtn from '../../components/public/return-btn';
import Characteristics from '../../components/public/characteristics';
import { addToCart } from '../../store/public/cart-slice';
            ...
            <div className="container">
              <div className="product__content">
                <div className="product__block product__block-pictures">
                  <a className="picture__link" href="src/pages/public/product-page">
                ...
                <div className="product__block product__block-info">
                  ...
                  <div className="product__wrapper">
                    ...
                    <div className="product__wrapper-item">
                      ...
                      <a className="product__description-link" href="src/pages/public/product-page">Перейти к описанию &gt;</a>
                    </div>
                  </div>
