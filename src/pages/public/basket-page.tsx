...
import CartList from '../../components/public/cart-list';
                  ...
                  <div className="cart__out-of-stock">
                    ...
                    <div className="cart-out-of-stock__items">
                      <div className="cart-out-of-stock-item">
                        <img className="cart-out-of-stock-item__img" src="src/pages/public/basket-page" alt=""/>
                        <a className="cart-out-of-stock-item__link" href="src/pages/public/basket-page#">
