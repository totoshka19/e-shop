      ...
      <div className="form__block">
        ...
        <div className="form-item form-item__wrapper">
          ...
          <p className="form-item__text">
              Нажимая на кнопку, вы соглашаетесь с <a className="form-item__link" href="src/components/public/order-form#">Условиями обработки персональных данных</a>,
              а также с <a className="form-item__link" href="src/components/public/order-form#">Условиями продажи</a>
          </p>
        </div>
      </div>
    </form>
